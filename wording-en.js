...
(() => {
  ...
  meta: {
    ...
    indexDescription: "Think you know pickleball? Prove it. A fast true-or-false pickleball rules game about serving, faults, scoring, line calls, and rule changes.",
    successTitle: "Full Access Ready - Pickleball Rules Quiz",
    successDescription: "Payment successful. Your Pickleball Rules Quiz device unlock code is ready.",
  ...
  system: {
    ...
    fatalConfigMissing: "Configuration error: application settings not loaded.",
    fatalWordingMissing: "Configuration error: UI wording not loaded.",
    fatalStorageUnsupported: "Your browser does not support local storage. Please use a modern browser.",
    fatalAppContainerMissing: "Critical error: app container not found.",
    fatalComponentsMissing: "Unable to load game components: {components}. Please refresh the page.",
    fatalIconsMissing: "Unable to load game components: WT_ICONS.renderIcon. Please refresh the page.",
    fatalContentUnavailable: "Content not available. Please check your connection and reload.",
    fatalDataLoadFailed: "Unable to load game data. Please check your connection and refresh.",
  ...
  landing: {
    ...
    personalBestSubTemplate: "Best score: {best}. Next tier at {nextTarget}+.",
    personalBestTopTierTemplate: "Best score: {best}. Top tier reached.",
    personalBestFirstTitle: "Set your first benchmark",
    personalBestFirstSubTemplate: "Score {nextTarget}+ to unlock your first tier.",
    dailyChallengeBadge: "TODAY'S CHALLENGE",
    dailyChallengeTitleTemplate: "Goal: {targetScore}+ score",
    dailyChallengeProgressTemplate: "Today: {score}/{targetScore} score. Resets in {time}.",
    dailyChallengeResetTemplate: "Reach {targetScore}+ score. Resets in {time}.",
    dailyChallengeCompletedTemplate: "Completed today. Resets in {time}.",
    dailyChallengeRewardTemplate: "Clear today's challenge to earn 1 Rapid Fire ticket.",
    dailyChallengeRewardCappedTemplate: "Tickets are capped at {cap}. Spend one to earn another.",
    dailyChallengeRewardPendingTemplate: "You already cleared it once. Clear it again today on your last free run to earn 1 Rapid Fire ticket.",
    dailyChallengeCta: "Try today's challenge",

    postPaywallTitle: "Your free preview is complete.",
    postPaywallBody: "Unlock unlimited RUNs, the full pickleball rules question set, explanations after every answer, and unlimited Mistakes Mode.",
    ...
    postPaywallSbBody: "Unlock full access to keep chasing today's challenge and earning Rapid Fire tickets."
  },

  leaderboard: {
    cardTitle: "THIS WEEK",
    cardSubDefault: "Public RUN leaderboard. Add your public nickname after your first completed run.",
    ...
    modalBodyDefault: "Choose a public nickname. Your best RUN score can appear in the weekly and all-time leaderboard.",
    modalBodyJoined: "Your best RUN score can appear in the weekly and all-time leaderboard.",
    ...
    remoteSaveErrorToast: "Nickname saved on this device. Remote sync can be connected later.",
    rankToastWeekly: "Public weekly rank: #{rank}.",
    scoreRejectedToast: "This RUN was not added to the public leaderboard this time."
  },
  ...
  ui: {
    ...
    dailyChallengeStartOverlayLineTemplate: "{targetScore}+ score = +1 Rapid Fire ticket",
  ...
  secretBonus: {
    ...
    startOverlayFreeRunsLimitLine: "{tickets} ticket{pluralS} left. Cost: {cost} ticket{costPluralS}.",

    freeLimitReachedTitle: "No Rapid Fire ticket available.",
    freeLimitReachedBody: "Rapid Fire costs {cost} ticket{costPluralS}.\nPlay today's challenge to earn one, or unlock full access to keep your main game open.",
  ...
  micropics: {
    ...
    freeLimitReachedBody: "You've used your {limit} free games.\n\nFull access unlocks unlimited RUNs, the full pickleball rules question set, explanations after every answer, unlimited Mistakes Mode, and the long-term daily loop.",
    freeLimitReachedCta: "Keep playing",
    freeLimitReachedClose: "Not now",
    ...
    endTagHighlights: {
      "2026 Changes": "The 2026 rule changes were the toughest part of this game."
    },
    ...
    dailyChallengeClearedFreeRun: "Today's challenge is cleared. The Rapid Fire ticket unlocks on your last free run.",
    dailyChallengeTicketWon: "Today's challenge cleared. +1 Rapid Fire ticket.",
    dailyChallengeTicketCapped: "Today's challenge cleared. Tickets are capped at {cap}. Spend one to earn more.",
    dailyChallengeMiss: "Today's challenge was {targetScore}+ score.",
    dailyChallengeMissLastFree: "Not this time. Today's challenge was {targetScore}+ score.",
    ...
    beatBestFirstLine: "Set your first best score next run.",
  ...
  paywall: {
    ...
    bridgeBody: "Unlock unlimited RUNs, the full question set, Mistakes Mode, and keep today's challenge alive over time.",
    bridgeBodyLastFreeMiss: "You've seen the real pace of the game. Unlock unlimited RUNs, the full question set, Mistakes Mode, and come back to today's challenge whenever you want.",
  ...
  howto: {
    ...
    autoReadHelp: "Read each new question aloud automatically. You can still replay or stop it during the game.",
    autoReadOn: "On",
    autoReadOff: "Off",
...
{url}`,
  ...
  statsSharing: {
    ...
    promptBodyTemplate: "You have now seen {thresholdPct}% of the question pool. Share anonymous gameplay stats to help improve difficulty, wording, and question order. You can review everything before sending.",
    promptBodyLastFree: "That was your last free game. Share anonymous gameplay stats to help improve difficulty, wording, and question order. You can review everything before sending.",
    promptBodyPowerUser: "You have played enough for your stats to be useful. Share anonymous gameplay stats to help improve difficulty, wording, and question order. You can review everything before sending.",
    promptCtaPrimary: "Review & share",
    promptCtaSecondary: "Not now",

    modalTitle: "Review anonymous stats",
    modalDescription: "This email includes your gameplay summary, your most-missed questions, and anonymous usage totals.\nNo personal identity data is included.\nYou can review exactly what will be sent below.",
    ...
    successToast: "Email draft opened. Send it if you want to share your stats.",
    copyToast: "Stats copied to clipboard.",
    mailtoFallbackToast: "Stats copied to clipboard. Paste them into the email draft."
  },
