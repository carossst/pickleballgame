...
(() => {
  ...
  meta: {
    ...
    indexDescription: "Vous croyez connaître le pickleball ? Prouvez-le. Un jeu rapide de vrai ou faux sur les règles : service, fautes, score, annonces de ligne, changements de règles.",
    successTitle: "Accès complet activé - Quiz Pickleball",
    successDescription: "Paiement réussi. Votre code de déverrouillage Quiz Pickleball est prêt.",
  ...
  system: {
    ...
    loadingSlowHint: "Toujours en cours... Vérifiez votre connexion si ça dure.",
    loadingSlowHints: [
    ...
    storageSaveFailedToast: "L'enregistrement est désactivé dans ce mode de navigation. Votre progression peut être perdue si vous actualisez la page.",
    confirmLeaveRun: "Quitter la partie en cours ? Votre progression sera perdue.",
    ...
    fatalConfigMissing: "Erreur de configuration : les paramètres de l'application n'ont pas été chargés.",
    fatalWordingMissing: "Erreur de configuration : les textes de l'interface n'ont pas été chargés.",
    fatalStorageUnsupported: "Votre navigateur ne prend pas en charge le stockage local. Utilisez un navigateur récent.",
    fatalAppContainerMissing: "Erreur critique : conteneur d'application introuvable.",
    fatalComponentsMissing: "Impossible de charger les composants du jeu : {components}. Actualisez la page.",
    fatalIconsMissing: "Impossible de charger les composants du jeu : WT_ICONS.renderIcon. Actualisez la page.",
    fatalContentUnavailable: "Contenu indisponible. Vérifiez votre connexion et rechargez la page.",
    fatalDataLoadFailed: "Impossible de charger les données du jeu. Vérifiez votre connexion puis actualisez la page.",
  ...
  success: {
    ...
    subtitle: "Votre code de déverrouillage est prêt. Utilisez-le dans le jeu pour activer l'accès complet sur cet appareil.",
    deviceBadge: "UN APPAREIL",

    codeLabel: "Votre code de déverrouillage",
    clearDataWarning: "Ce déverrouillage est enregistré sur cet appareil. Gardez le code au cas où vous effaceriez vos données ou changeriez d'appareil.",
    ...
    shortcutHint: "Dans le jeu : Comment jouer -> Utiliser un code de déverrouillage.",
    ...
    tipNoRecover: "Astuce : gardez ce code en lieu sûr comme sauvegarde de votre déverrouillage.",
    txtTitle: "Votre code de déverrouillage Quiz Pickleball",
    txtSaveLine: "Astuce : gardez ce code en lieu sûr si vous voulez une sauvegarde.",
    txtNoRecoverLine: "Vous n'en aurez besoin à nouveau que si vous effacez vos données ou changez d'appareil.",
  ...
  landing: {
    ...
    personalBestSubTemplate: "Meilleur score : {best}. Prochain palier à {nextTarget}+.",
    personalBestTopTierTemplate: "Meilleur score : {best}. Vous avez atteint le plus haut palier.",
    personalBestFirstTitle: "Fixez votre premier repère",
    personalBestFirstSubTemplate: "Marquez {nextTarget}+ pour débloquer votre premier palier.",
    dailyChallengeBadge: "DÉFI DU JOUR",
    dailyChallengeTitleTemplate: "Objectif : {targetScore}+ au score",
    dailyChallengeProgressTemplate: "Aujourd'hui : {score}/{targetScore} au score. Réinitialisation dans {time}.",
    dailyChallengeResetTemplate: "Atteignez {targetScore}+ au score. Réinitialisation dans {time}.",
    dailyChallengeCompletedTemplate: "Terminé aujourd'hui. Réinitialisation dans {time}.",
    dailyChallengeRewardTemplate: "Réussissez le défi du jour pour gagner 1 ticket Mode Rapide.",
    dailyChallengeRewardCappedTemplate: "Les tickets sont plafonnés à {cap}. Dépensez-en un pour en regagner.",
    dailyChallengeRewardPendingTemplate: "Vous l'avez déjà réussi une fois. Réussissez-le à nouveau aujourd'hui sur votre dernière run gratuite pour gagner 1 ticket Mode Rapide.",
    dailyChallengeCta: "Essayer le défi du jour",

    postPaywallTitle: "Votre aperçu gratuit est terminé.",
    postPaywallBody: "Débloquez des RUNs illimitées, toutes les questions sur les règles du pickleball, les explications après chaque réponse et le Mode Erreurs illimité.",
    ...
    postPaywallSbBody: "Débloquez l'accès complet pour continuer à viser le défi du jour et gagner des tickets Mode Rapide."
  },

  leaderboard: {
    cardTitle: "CETTE SEMAINE",
    cardSubDefault: "Classement public des RUNs. Ajoutez votre pseudo public après votre première run terminée.",
    cardSubJoined: "Classement public des RUNs. Votre meilleure RUN peut apparaître ici.",
    ...
    modalBodyDefault: "Choisissez un pseudo public. Votre meilleur score en RUN pourra apparaître dans le classement hebdomadaire et all-time.",
    modalBodyJoined: "Votre meilleur score en RUN peut apparaître dans le classement hebdomadaire et all-time.",
    ...
    nicknameInvalidCharsToast: "Utilisez seulement des lettres, chiffres, espaces, tirets ou underscores.",
    saveOkToast: "Pseudo de classement enregistré.",
    leftToast: "Vous avez quitté le classement sur cet appareil.",
    remoteSaveErrorToast: "Pseudo enregistré sur cet appareil. La synchro distante pourra être branchée ensuite.",
    rankToastWeekly: "Rang public cette semaine : #{rank}.",
    scoreRejectedToast: "Cette RUN n'a pas été ajoutée au classement public cette fois."
  },
  ...
  phaseJourney: {
    discovery: {
      ...
      landingDetailTemplate: "Il en reste {remaining} pour votre premier passage.",
      endLens: "Vous faites votre premier passage. L'objectif est maintenant de voir plus de questions.",
      micropics: {
    ...
    correction: {
      ...
      landingDetail: "Vous avez vu toutes les questions. Corrigez maintenant les règles qui vous piègent encore.",
      endLens: "Vous avez vu toutes les questions. Corrigez maintenant les règles qui vous piègent encore.",
      micropics: {
    ...
    consolidation: {
      ...
      landingDetail: "Vos erreurs sont corrigées. Testez votre score en Mode Rapide.",
      endLens: "Vos erreurs sont corrigées. Testez votre score en Mode Rapide.",
      micropics: {
  ...
  levels: {
    ...
    byLevel: {
      1: {
        ...
        sheetBody: "Vous avez terminé votre premier passage complet. Maintenant, consolidez les règles."
      },
      2: {
        label: "NIVEAU CLUB",
        unlock: "Corrigez toutes les erreurs actives.",
        sheetBody: "Vous avez corrigé vos erreurs actives. Votre connaissance des règles devient fiable."
      },
      3: {
        label: "NIVEAU COMPÉTITION",
        unlock: "Construisez une sélection Mode Rapide de 16 questions ou plus et réussissez une partie à 70% ou plus.",
        sheetBody: "Vous avez prouvé votre connaissance des règles sous la pression du Mode Rapide."
      },
      4: {
        label: "NIVEAU PRO",
        unlock: "Construisez une sélection Mode Rapide de 50 questions ou plus et réussissez une partie à 85% ou plus.",
        sheetBody: "Vous avez atteint le niveau le plus haut. Gardez vos règles affûtées."
      }
    }
  },
  ...
  ui: {
    ...
    startRunChancesOverlay: "Bonne réponse : +1 point.\nMauvaise réponse : +1 erreur.\nLa partie se termine après {maxChances} erreurs.",
    startOverlayTapAnywhere: "Appuyez n'importe où pour commencer",
    dailyChallengeStartOverlayLabel: "Le défi du jour est actif",
    dailyChallengeStartOverlayLineTemplate: "{targetScore}+ au score = +1 ticket Mode Rapide",
  ...
  secretBonus: {
    ...
    chestHint: "",
    starterTicketToast: "1 ticket Mode Rapide ajouté. Vous pouvez l'utiliser maintenant.",
    noSeenWordsToast: "Le Mode Rapide est vide pour l'instant. Jouez quelques parties pour construire votre sélection.",
    badge: "MODE RAPIDE",
    ...
    endRecoByTier: {
      perfect_small: "Élargissez votre sélection pour débloquer plus de questions en Mode Rapide.",
      perfect_medium: "Rejouez pour garder cet avantage.",
      perfect_large: "Votre sélection Mode Rapide est solide : continuez.",
      high_small: "Élargissez votre sélection pour débloquer plus de questions en Mode Rapide.",
      high_medium: "Réessayez pour ancrer celles que vous avez ratées.",
      high_large: "Restez en Mode Rapide : c'était une belle partie.",
      medium_small: "Élargissez d'abord votre sélection. Plus de questions vues = Mode Rapide plus solide.",
      medium_medium: "Refaites une partie en Mode Rapide pour renforcer votre rappel.",
      medium_large: "Continuez. La mémoire s'ancre avec la répétition.",
      low_small: "Élargissez d'abord votre sélection. Plus de questions vues = Mode Rapide plus solide.",
      low_medium: "Refaites une partie en Mode Rapide pour reprendre confiance.",
  ...
  practice: {
    ...
    endRepeatNoteByTier: {
      ...
      direct: "Restez en Mode Erreurs. Ce sont les questions qui demandent du travail."
    },

    scoreLine: "Score : {score}",
    playingProgressLine: "{current}/{total}",

    startRunChancesOverlayPractice: "Uniquement vos questions ratées.\nJusqu'à 10 par partie.\nCorrigez-la et elle sort. Ratez-la et elle revient.",
    startOverlayTapAnywhere: "Appuyez n'importe où pour commencer",
  ...
  micropics: {
    ...
    poolCompleteLine1: "Vous avez parcouru tout le quiz. Maintenant, rejouez, corrigez les erreurs et consolidez les règles.",
    poolCompleteLine2: "Revenez plus tard pour voir ce qui reste vraiment acquis.",
    directToConsolidationLine: "Vous avez terminé tout l'ensemble sans erreur active : vous passez directement en phase 3.",
    ...
    freeLimitReachedBody: "Vous avez utilisé vos {limit} parties gratuites.\n\nL'accès complet débloque des RUNs illimitées, toutes les questions sur les règles du pickleball, les explications après chaque réponse, le Mode Erreurs illimité et la boucle Daily dans la durée.",
    freeLimitReachedCta: "Continuer à jouer",
    freeLimitReachedClose: "Plus tard",
    ...
    endTagHighlights: {
      "2026 Changes": "Les changements de règles de 2026 ont été votre catégorie la plus difficile sur cette partie."
    },
    ...
    dailyChallengeClearedFreeRun: "Défi du jour réussi. Le ticket Mode Rapide se gagne sur votre dernière run gratuite.",
    dailyChallengeTicketWon: "Défi du jour réussi. +1 ticket Mode Rapide.",
    dailyChallengeTicketCapped: "Défi du jour réussi. Les tickets sont plafonnés à {cap}. Dépensez-en un pour en regagner.",
    dailyChallengeMiss: "Le défi du jour demandait {targetScore}+ au score.",
    dailyChallengeMissLastFree: "Pas encore. Le défi du jour demandait {targetScore}+ au score.",
    ...
    beatBestLine: "Prochain objectif : dépasser votre meilleur score avec {target}+.",
    beatBestFirstLine: "Prochain objectif : signer un premier meilleur score.",
    freeRunLeft: "Il vous reste {remaining} partie{pluralS} gratuite{pluralS}.",
  ...
  paywall: {
    ...
    progressLine1: "Vous avez vu {seen} questions. Il en reste {remaining} dans le quiz complet.",
    progressLine2: "",
    ...
    compactBullets: [
      "**Toutes les questions sur les règles du pickleball**",
      "**RUNs illimitées**",
    ...
    bridgeBody: "Débloquez des RUNs illimitées, toutes les questions, le Mode Erreurs, et gardez le défi du jour vivant dans le temps.",
    bridgeBodyLastFreeMiss: "Vous avez vu le vrai rythme du jeu. Débloquez des RUNs illimitées, toutes les questions, le Mode Erreurs, et revenez sur le défi du jour quand vous voulez.",
    ...
    socialProofQuotes: [
      { quote: "★★★★★\nJe pensais tout connaître. J'ai découvert trois règles que je comprenais mal au club. Les explications aident vraiment.", author: "Maya, joueuse de tournoi" },
      { quote: "★★★★★\nEn deux parties, j'ai réalisé que je faisais des erreurs depuis des mois.", author: "Jon, habitué du double" }
    ],

    savingsLineTemplate: "Économisez {saveAmount} avec le prix de lancement.",
    checkoutNote: "Paiement traité en toute sécurité par Stripe. En général, cela prend environ 30 secondes.",
    ...
    alreadyHaveCode: "Vous avez déjà un code de déverrouillage ? Utilisez-le ici.",
    deviceNote: "Déverrouillage instantané. Pas de compte requis. Gardez votre code comme sauvegarde.",
    ...
    postEarlyLine2: "{standardPrice}. Payez une fois. Gardez votre code comme sauvegarde."
  },

  howto: {
    title: "Comment jouer",
    howToPlayLine1: "Vous voyez une affirmation sur les règles du pickleball.",
    ...
    autoReadHelp: "Lit automatiquement chaque nouvelle question à voix haute. Vous pouvez toujours la relire ou arrêter la lecture pendant la partie.",
    autoReadOn: "Activé",
    ...
    ruleSentence: "Chaque bonne réponse ajoute 1 point. Une mauvaise réponse ajoute 1 erreur. Après {maxChances} erreurs, la partie est terminée.",
    ...
    activateLine1: "Vous avez déjà un code de déverrouillage ? Utilisez-le ici.",
    activateLine2: "Pas besoin de compte. Gardez votre code comme sauvegarde.",
    ...
    autoActivateLine1: "Votre code de déverrouillage est déjà enregistré ici.",
    autoActivateLine2: "Activer l'accès complet sur cet appareil maintenant ?",
  ...
  postCompletion: {
    ...
    masteredTitle: "Bravo ! Vous avez répondu correctement à toutes les questions.",
    masteredLine1: "Zéro erreur restante. Chaque question répondue correctement.",
    masteredLine2: "Maintenant, mettez votre connaissance des règles sous pression. Puis revenez dans quelques semaines voir si ça tient encore.",
    ...
    waitlistBody1: "Recevez un message quand de nouvelles questions ou fonctionnalités sont ajoutées.",
    waitlistBody2: "Pas de spam. Pas de compte. Désinscription à tout moment.",
    waitlistCta: "Être prévenu",
    waitlistDisclaimer: "Adresse email uniquement. Désinscription à tout moment.",
  ...
  houseAd: {
    ...
    bodyLine1: "Carole, la créatrice de Quiz Pickleball, partage son temps entre les États-Unis et la France.",
    bodyLine2: "Rejoignez la liste Bonjour Pickleball pour de futurs voyages, stages et expériences en petit groupe en France.",
    ...
    landingBodyLine1: "Carole, la créatrice de Quiz Pickleball, partage son temps entre les États-Unis et la France.",
    landingBodyLine2: "Rejoignez la liste Bonjour Pickleball pour de futurs voyages, stages et expériences en petit groupe en France.",
...
{url}`,
  ...
  installPrompt: {
    ...
    bodyIOS: "Sur iPhone, appuyez sur Partager, puis Ajouter à l'écran d'accueil.",
  ...
  statsSharing: {
    ...
    promptBodyTemplate: "Vous avez maintenant vu {thresholdPct}% du pool de questions. Partagez des stats de jeu anonymes pour aider à améliorer la difficulté, les formulations et l'ordre des questions. Vous pouvez tout relire avant d'envoyer.",
    promptBodyLastFree: "C'était votre dernière partie gratuite. Partagez des stats de jeu anonymes pour aider à améliorer la difficulté, les formulations et l'ordre des questions. Vous pouvez tout relire avant d'envoyer.",
    promptBodyPowerUser: "Vous avez assez joué pour que vos stats soient utiles. Partagez des stats de jeu anonymes pour aider à améliorer la difficulté, les formulations et l'ordre des questions. Vous pouvez tout relire avant d'envoyer.",
    promptCtaPrimary: "Voir avant d'envoyer",
    promptCtaSecondary: "Plus tard",

    modalTitle: "Vérifier les stats anonymes",
    modalDescription: "Cet email contient votre résumé de jeu, les questions que vous ratez le plus, et des totaux d'usage anonymes.\nAucune donnée personnelle n'est incluse.\nVous pouvez vérifier exactement ce qui sera envoyé ci-dessous.",
    ...
    successToast: "Brouillon d'email ouvert. Envoyez-le si vous voulez partager vos stats.",
    copyToast: "Stats copiées dans le presse-papier.",
    mailtoFallbackToast: "Stats copiées dans le presse-papier. Collez-les dans le brouillon d'email."
  },
